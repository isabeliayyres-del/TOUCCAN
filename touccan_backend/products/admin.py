...
class CategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informações básicas", {"fields": ("name", "description", "parent")}),
        ("Configurações", {"fields": ("slug", "is_active")}),
    )
...
class ProductAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Preço e Estoque", {"fields": ("price", "stock_quantity")}),
        ("Configurações", {"fields": ("slug", "is_active", "featured")}),
    )
